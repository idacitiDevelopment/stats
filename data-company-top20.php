  ...
  <div class="content">
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Top 20 Companies</h2>
        <ol class="breadcrumb">
          <!--<li><a href="./index.html">Home</a></li>
          <li><a href="javascript:;">Extra Pages</a></li>-->
          <li class="active">The top 20 companies used in cards</li>
        </ol>
      </div> <!-- /.content-header -->
...
$xcrud->table_name('Top 20 Companies');
$xcrud->query('select company.company_name, count(company) as uses from card_company,company where card_company.company = company.entity_id group by company.entity_id order by uses desc LIMIT 20');
