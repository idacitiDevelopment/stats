  ...
  <div class="content">
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        <h2 class="content-header-title">Top 20 Storyboard Creators</h2>
        <ol class="breadcrumb">
          <!--<li><a href="./index.html">Home</a></li>
          <li><a href="javascript:;">Extra Pages</a></li>-->
          <li class="active">The top 20 users as storyboard creators</li>
        </ol>
      </div> <!-- /.content-header -->
...
$xcrud->query('select concat_ws(" ",first_name,last_name) as user, count(storyboard.id) as boards from storyboard,user where storyboard.user = user.id group by user.id order by boards desc LIMIT 20');
