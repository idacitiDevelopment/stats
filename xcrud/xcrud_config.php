...
{
    // default connection
    public static $dbname = 'idacitin_companies'; // Your database name
    public static $dbuser = 'idacitin_test'; // Your database username
    public static $dbpass = 'Id@citi1026'; // // Your database password
