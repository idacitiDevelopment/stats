...
from user
where is_active = 1 and is_root = 1
...
and user.is_active = 1 and user.is_root = 1
    ...
    <div class="content-container">
      ...
      <div class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><strong><?php echo $users ?></strong> Active Users (Internal)</li>
        </ol>
      </div> <!-- /.content-header -->
      <div class="row">
...
$xcrud->table('user');
$xcrud->table_name('Active Internal Users');
//$xcrud->relation('user_id','user','user_id','name');
$xcrud->where("","is_active = 1 AND is_root = 1");
$xcrud->order_by('last_name','asc');
//$xcrud->readonly('login');
$xcrud->columns('last_name,first_name,email');
