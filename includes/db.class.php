...
class db_class {
    ...
    function __construct() {
       ...
       $this->host = db_config::$host; //'localhost';
        $this->user = db_config::$username;//'idacitin_test';
        $this->pass = db_config::$password;//'Id@citi1026';
        $this->database = db_config::$database; //'idacitin_companies';
...
//MATT DONE THIS
    ...
    public function escape_data($data) {
        ...
        $data = mysqli_real_escape_string($this->database, trim($data));
